!(function (t, e) {
  ...
  return (
    ...
    (u.dialog = function (t) {
          ...
          w(r, function (t, e, o) {
            ...
            e.label || (e.label = t),
              e.className ||
                ...
                (e.className =
                  n <= 2 && t ? "btn-primary" : "btn-secondary btn-default"));
          }),
          a
        );
      })(t)),
        c.fn.modal.Constructor.VERSION
          ? ((t.fullBootstrapVersion = c.fn.modal.Constructor.VERSION),
      ...
      if (
        (t.reusable || o.one("hidden.bs.modal", { dialog: o }, v), t.onHidden)
      ) {
        ...
        (n.buttons.confirm.callback = function () {
          ...
          if ("checkbox" === n.inputType)
            t = r
              ...
              .get();
          else if ("radio" === n.inputType) t = r.find("input:checked").val();
          else {
      ...
      switch (((r = c(d.inputs[n.inputType])), n.inputType)) {
        ...
        case "select":
          ...
          n.placeholder && r.attr("placeholder", n.placeholder),
            ...
            w(a, function (t, e) {
              ...
              e.group &&
                (i[e.group] ||
                  (i[e.group] = c("<optgroup />").attr("label", e.group)),
                (o = i[e.group]));
              var a = c(d.option);
        ...
        case "radio":
          ...
          w(a, function (t, e) {
            ...
            s && r.find('input[type="radio"]').first().prop("checked", !0);
      }
      return (
        o.append(r),
